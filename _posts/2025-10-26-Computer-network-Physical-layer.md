...
>❗同步的方法<div style="background-color: #616161; border-left: 4px solid #ffc107; padding: 10px; > margin: 10px 0;"> <strong>✅外同步:在收发双方间添加一条单独的时钟信号线</strong><br><strong>✅内同步：发送端将同步时钟信号编码到发送数据中一起传输</strong></div>
